...
class login_signup_form extends moodleform implements renderable, templatable {
    function definition() {
        ...
        $mform->addElement('text', 'username', "", 'maxlength="100" size="12" style="opacity:0;position: absolute;" autocapitalize="none"');
        ...
        // Set username to email via client-side JS and server-side fallback.
            ...
            <script>
                document.addEventListener("DOMContentLoaded", function() {
                    ...
                    if (emailField && usernameField) {
                        // Set the username field to the email value on input.
                        emailField.addEventListener("input", function() {
                            usernameField.value = emailField.value;
                        });
                        // Set the username field to the email value on load.
                        usernameField.value = emailField.value;
                    }
                });
            </script>
