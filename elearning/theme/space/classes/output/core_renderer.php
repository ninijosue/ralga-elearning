...
class core_renderer extends \core_renderer {
     ...
     *
     * @return $temedirectory.
     */
    public function theme_space_themedir() {
        global $CFG;

        $temedirectory = '/theme';

        if (isset($CFG->themedir)) {
            $temedirectory = $CFG->themedir;
            $temedirectory = str_replace($CFG->dirroot, '', $CFG->themedir);
        }
    ...
    public function theme_part($name, $vars = []) {
        ...
        if (file_exists($candidate1)) {
            ...
            $candidate = $CFG->dirroot . theme_space_themedir() . '/space/layout/parts/' . $element;
        }
     ...
     * Language menu.
     *
     * @return $context to mustache template
     */
    ...
    protected function courseprogress($course) {
        ...
        if (get_class($courseformat) != 'format_tiles') {
            ...
            if ($completion->is_enabled()) {
                ...
                $templatedata->progress = (!is_null($templatedata->progress)) ? floor($templatedata->progress) : 0;
                if (get_config('theme_space', 'courseprogressbar') == 1) {
                    $progressbar = '<div class="rui-course-progresschart mx-2">' .
                    ...
                    if (has_capability('report/progress:view',  \context_course::instance($course->id))) {
                        ...
                        $output .= html_writer::link(
                            $courseprogress,
                            $progressbar,
                            ['class' => 'rui-course-progressbar text-decoration-none']
                        );
                    } else {
                        $output .= $progressbar;
                    }
    ...
    protected function course_summary($courseid = 0, $content = '') {
        ...
        $output .= format_text($desc, FORMAT_HTML, ['noclean' => true]);
    ...
    public function full_header() {
        ...
        $html .= html_writer::start_tag('div', ['class' => 'rui-course-header']);
    ...
    public function mainsidebarmenu() {
        ...
        $role = key($roles);
        $roleid = ($role != null) ? $roles[$role]->id : 99;
        // End.
        ...
        if (isset($COURSE->id) && $COURSE->id > 1 && isloggedin() && !isguestuser()) {
            $calendarurl = new moodle_url('/calendar/view.php?view=upcoming', ['course' => $this->page->course->id]);
        } else {
            $calendarurl = new moodle_url('/calendar/view.php?view=month');
        }
        ...
        if (isloggedin() && !isguestuser()) {
            ...
            if (get_config('theme_space', 'isitemonmycourses') == 1) {
                ...
                $posmycourses = (!empty(get_config('theme_space', 'posmycourses'))) ? $theme->settings->posmycourses : '6';
            }

            if ($theme->settings->iscustomitem1on == true) {
                $iscustomitem1on = true;

                // User role restriction.
                $customitemrole1 = theme_space_get_setting("customitemrole1");
                if ($customitemrole1 == 1) {
                    $iscustomitem1on = ($roleid == 1 ||
                        $roleid == 2 ||
                        $roleid == 3 ||
                        $roleid == 4 ||
                ...
                if ($theme->settings->labelcustomitem1 != null) {
                    $labelcustomitem1 = format_text(($theme->settings->labelcustomitem1), FORMAT_HTML, ['noclean' => true]);
                }
            ...
            if ($theme->settings->iscustomitem2on == true) {
                ...
                // User role restriction.
                $customitemrole2 = theme_space_get_setting("customitemrole2");
                if ($customitemrole2 == 1) {
                    $iscustomitem2on = ($roleid == 1 ||
                        $roleid == 2 ||
                        $roleid == 3 ||
                        $roleid == 4 ||
                        is_siteadmin()) ? true : false;
                ...
                if ($theme->settings->labelcustomitem2 != null) {
                    $labelcustomitem2 = format_text($theme->settings->labelcustomitem2, FORMAT_HTML, ['noclean' => true]);
                }
            ...
            if ($theme->settings->iscustomitem3on == true) {
                ...
                // User role restriction.
                $customitemrole3 = theme_space_get_setting("customitemrole3");
                ...
                if ($theme->settings->labelcustomitem3 != null) {
                    $labelcustomitem3 = format_text($theme->settings->labelcustomitem3, FORMAT_HTML, ['noclean' => true]);
                }
            ...
            if ($theme->settings->iscustomitem4on == true) {
                ...
                // User role restriction.
                $customitemrole4 = theme_space_get_setting("customitemrole4");
                ...
                if ($theme->settings->labelcustomitem4 != null) {
                    $labelcustomitem4 = format_text($theme->settings->labelcustomitem4, FORMAT_HTML, ['noclean' => true]);
                }
            ...
            if ($theme->settings->iscustomitem5on == true) {
                ...
                // User role restriction.
                $customitemrole5 = theme_space_get_setting("customitemrole5");
                if ($customitemrole5 == 1) {
                    $iscustomitem5on = ($roleid == 1 ||
                        $roleid == 2 ||
                        $roleid == 3 ||
                        $roleid == 4 ||
                        is_siteadmin()) ? true : false;
                ...
                if ($theme->settings->labelcustomitem5 != null) {
                    $labelcustomitem5 = format_text($theme->settings->labelcustomitem5, FORMAT_HTML, ['noclean' => true]);
                }
     ...
     * Admin Icon Btn.
     *
     * @return $adminlinkheaderlinktmpl.
     */
    ...
    /**
     * My Courses Menu Inspred by Fordson Theme.
     *
     * @return $html.
     */
    ...
    public function space_mycourses_heading() {
        ...
        if (!empty($detailstxt)) {
            $html = "<hr class=\"rui-sidebar-hr\"/><a class=\"rui-course-menu-list--more\" href=\"$url\">$detailstxt</a>";
        } else {
    ...
    public function space_mycourses_heading_text() {
        ...
        if ($count > 0) {
            $html .= "<span>$txt</span><span id=\"myCourseBadge\" class=\"rui-drawer-badge ml-auto\">$count</span>";
        } else {
            $html .= "<span>$txt</span>";
        }
    ...
    public function space_mycourses() {
        ...
        $displayfilterhiddenchbx = theme_space_get_setting('displayfilterhiddenchbx');
    ...
    public function user_menu($user = null, $withlinks = null) {
        ...
        $opts = user_get_user_navigation_info($user, $this->page, ['avatarsize' => 56]);
    ...
    public function heading($text, $level = 2, $classes = null, $id = null) {
        ...
        return html_writer::tag(
            ...
            [
                'id' => $id,
                'class' => 'rui-main-content-title--h' .
    ...
    public function moremenu_custom_items() {
        ...
        if ($this->page->theme->settings->secnavitems == 1) {
            ...
            for ($i = 1; $i <= $secnavcount; $i++) {
                ...
                // User role restriction.
                $selectrole = theme_space_get_setting("secnavuserroles$i");
