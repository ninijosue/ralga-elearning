...
<br /><img src="{$a->siteurl}/theme/space/doc/video-size.jpg" class="img-fluid rounded my-3" style="max-height: 200px; width: auto; max-width: 100%;" alt="Space Moodle Theme" />';

$string['accessiblelinks'] = 'Accessible Links (Beta version)';
...
$string['pluginname'] = 'Space (2.5.27)';
...
$string['courseprogressbar_desc'] = 'Course progress bar displays on the course index sidebar<br /><div class="w-100 mt-2"><img src="{$a->siteurl}/theme/space/doc/course-progressbar.png" class="img-fluid rounded w-100" style="max-width: 500px;" alt="space Moodle Theme" /></div>';
...
<br /><img src="{$a->siteurl}/theme/space/doc/topbar-custom-html.png" class="img-fluid rounded my-3" style="max-height: 100px; width: auto; max-width: 100%;" alt="Space Moodle Theme" />
...
&lt;p&gt;Space (2.5.27) is here!&lt;br&gt;&lt;a href=&quot;#&quot; target=&quot;_blank&quot;&gt;Get this theme today!&lt;/a&gt;
&lt;/p&gt;
&lt;/div&gt;</pre>';
...
$string['block0'] = 'Block #0 <span class="mt-1 small d-block w-100">Main Moodle Content</span><span class="badge-xs badge-light mt-2">Go to the settings - <a href="{$a->siteurl}/admin/settings.php?section=frontpagesettings" target="_blank">Edit</a></span>';
$string['block0_desc'] = '';
$string['block01'] = 'Block #01 <span class="mt-1 small d-block w-100">Front Page Blocks Area #1</span>';
$string['block01_desc'] = '';
$string['block02'] = 'Block #02 <span class="mt-1 small d-block w-100">Front Page Blocks Area #2</span>';
$string['block02_desc'] = '';
$string['block1'] = 'Block #1 <span class="mt-1 small d-block w-100">Hero Slider</span>';
$string['block1_desc'] = '';
$string['block2'] = 'Block #2 <span class="mt-1 small d-block w-100">Hero Video</span>';
$string['block2_desc'] = '';
$string['block3'] = 'Block #3 <span class="mt-1 small d-block w-100">Hero Image</span>';
$string['block3_desc'] = '';
$string['block4'] = 'Block #4 <span class="mt-1 small d-block w-100">FAQ</span>';
$string['block4_desc'] = '';
$string['block5'] = 'Block #5 <span class="mt-1 small d-block w-100">Content</span>';
$string['block5_desc'] = '';
$string['block6'] = 'Block #6 <span class="mt-1 small d-block w-100">Testimonials</span>';
$string['block6_desc'] = '';
$string['block7'] = 'Block #7 <span class="mt-1 small d-block w-100">Grid Content #1</span>';
$string['block7_desc'] = '';
$string['block8'] = 'Block #8 <span class="mt-1 small d-block w-100">Grid Content #2</span>';
$string['block8_desc'] = '';
$string['block9'] = 'Block #9 <span class="mt-1 small d-block w-100">Grid Content #3</span>';
$string['block9_desc'] = '';
$string['block10'] = 'Block #10 <span class="mt-1 small d-block w-100">Logotypes</span>';
$string['block10_desc'] = '';
$string['block11'] = 'Block #11 <span class="mt-1 small d-block w-100">Grid Content #4</span>';
$string['block11_desc'] = '';
$string['block12'] = 'Block #12 <span class="mt-1 small d-block w-100">Stats #1</span>';
$string['block12_desc'] = '';
$string['block13'] = 'Block #13 <span class="mt-1 small d-block w-100">CTA #1</span>';
$string['block13_desc'] = '';
$string['block14'] = 'Block #14 <span class="mt-1 small d-block w-100">CTA #2</span>';
$string['block14_desc'] = '';
$string['block15'] = 'Block #15 <span class="mt-1 small d-block w-100">Grid Content #5</span>';
$string['block15_desc'] = '';
$string['block16'] = 'Block #16 <span class="mt-1 small d-block w-100">Content</span>';
$string['block16_desc'] = '';
$string['block17'] = 'Block #17 <span class="mt-1 small d-block w-100">Stats #2</span>';
$string['block17_desc'] = '';
$string['block18'] = 'Block #18 <span class="mt-1 small d-block w-100">Team</span>';
$string['block18_desc'] = '';
$string['block19'] = 'Block #19 <span class="mt-1 small d-block w-100">CTA #3</span>';
$string['block19_desc'] = '';
$string['block20'] = 'Block #20 <span class="mt-1 small d-block w-100">Hero Slider #2 from Space 1.14</span>';
$string['block20_desc'] = '';
$string['block21'] = 'Block #21 <span class="mt-1 small d-block w-100">Grid Content #6</span>';
$string['block21_desc'] = '';
$string['block22'] = 'Block #22 <span class="mt-1 small d-block w-100">Categories List #1</span>';
$string['block22_desc'] = '';
$string['block23'] = 'Block #23 <span class="mt-1 small d-block w-100">Categories List #2</span>';
$string['block23_desc'] = '';
...
$string['sliderimage'] = 'Slider picture <span class="badge badge-xs badge-info mx-2">1320px x 600px</spanl>';
...
$string['displayblock24_desc'] = '';
$string['settingsblock25'] = 'Block #02';
$string['displayblock25_desc'] = '';
...
<br /><img src="{$a->siteurl}/theme/space/doc/logo-text.png" class="img-fluid rounded my-3" style="max-height: 100px; width: auto; max-width: 100%;" alt="Space Moodle Theme" />';
...
$string['hdmcolorsprimary'] = 'Primary dms <span class="badge badge-xs badge-dark mx-2">Dark Mode</span>';
...
$string['hintro'] = '<img src="{$a->siteurl}/theme/space/doc/theme-icon.svg" class="img-fluid rounded my-3" width="80" height="80" alt="space Moodle Theme" /><div class="lead-3">Space for Moodle 4.3</div>';
$string['hintro_desc'] = '
<div class="mt-1 small">by <a href="https://rosea.io">RoseaThemes</a></div><hr class="mt-3" />
<div class="mt-3"><span class="badge badge-light">Version: 2.5.27</span></div>
...
<br /><img src="{$a->siteurl}/theme/space/doc/hints.png" class="img-fluid rounded my-3" style="max-height: 200px; width: auto; max-width: 100%;" alt="space Moodle Theme" />';
...
<br /><img src="{$a->siteurl}/theme/space/doc/sidebar-labels.png" class="rounded mt-3" style="max-width: 500px;max-height:150px;width:100%;" />';

$string['secnavgroupitem'] = 'Include Groups Item to the Secondary Navigation';
$string['secnavgroupitem_desc'] = 'For users who have capabilities such as moodle/course:managegroups. <br /><img src="{$a->siteurl}/theme/space/doc/secondary-nav-course-tmpl.png" class="rounded mt-3" style="max-width:500px;max-height:150px;width:100%;" />';
