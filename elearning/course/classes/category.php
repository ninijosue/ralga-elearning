...
class core_course_category implements renderable, cacheable_object, IteratorAggregate {
     ...
     * @return core_course_list_element[]
     */
    public function get_courses($options = array('customFields' => true)) {
        global $DB, $USER;
        ...
        if ($ids !== false) {
            ...
            //  ;
            if(isloggedin() && isset($moreuserinfo) && !is_siteadmin($userid)){
                    ...
                    foreach ($customfields as $fielddata) {
                        ...
                        if ($shortname == 'point_of_service_category') {
                            ...
                            if($value !== "" && isset($pointofservices[$value])){
                                ...
                                if(str_contains($label, $servicepointcategory) || $servicepointcategory === $pointofservices["7"] ){
