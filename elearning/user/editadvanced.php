...
echo '
<style>
#id_firstname, #id_lastname, #id_username, #id_email {
  pointer-events: none !important;
  background: #eee !important;

}
  #fitem_id_moodlenetprofile, #fitem_id_city, #fitem_id_country, #fitem_id_timezone, #fitem_id_description_editor, 
  #id_moodle_picture, #id_moodle_additional_names, #id_moodle_interests, #id_moodle_optional {
